...
data class SessionMetadata(
    ...
    val rtklibEnabled: Boolean = false,
    val rtklibPreset: String? = null,
    val rtklibSnapshotId: String? = null,
    val rtklibRoutePlan: String? = null,
    val rtklibValidationSummary: String? = null,
    val rtklibOutputNmea: Boolean = false,
    val rtklibOutputPos: Boolean = false,
    val rtklibFrequencyCount: Int? = null,
    val rtklibServerCycleMillis: Int? = null,
    val rtklibServerBufferBytes: Int? = null,
    val rtklibSolutionBufferBytes: Int? = null,
    val solutionPolicyProfileId: String? = null,
    val solutionScreenPolicy: String? = null,
    val solutionMockPolicy: String? = null,
