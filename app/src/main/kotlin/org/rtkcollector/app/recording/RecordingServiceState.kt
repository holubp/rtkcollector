...
data class RecordingServiceState(
    ...
    val baseCasterUploadSafetyMaxBitrateKbps: Int = 35,
    val baseCasterUploadSafetyBitrateWindowSeconds: Int = 60,
    val baseCasterUploadSafetyMaxSessionUploadMb: Int = 500,
    val baseCasterUploadNoDataTimeoutSeconds: Int = 12,
    val baseCasterUploadStopAfterConsecutiveFailures: Int = 5,
    ...
    val correctionLastUpdatedAtMillis: Long? = null,
    ...
    val ubloxFrequency: String = "Frequency RAWX/SFRBX/TM2/NAV-PVT/NAV-SAT/NAV-DOP/GGA -/-/-/-/-/-/- Hz",
...
internal fun RecordingServiceState.applyBestSolutionDisplayDelta(
    ...
    return copy(
        ...
        baseCandidateLatDeg = delta.latDeg,
        baseCandidateLonDeg = delta.lonDeg,
        baseCandidateEllipsoidalHeightM = delta.ellipsoidalHeightM,
        baseCandidateMslAltitudeM = delta.mslAltitudeM,
...
internal fun RecordingServiceState.withSelectedSolution(
    ...
    copy(
        ...
        baseCandidateLatDeg = candidate.latDeg,
        baseCandidateLonDeg = candidate.lonDeg,
        baseCandidateEllipsoidalHeightM = candidate.ellipsoidalHeightM,
        baseCandidateMslAltitudeM = candidate.mslAltitudeM,
    )
