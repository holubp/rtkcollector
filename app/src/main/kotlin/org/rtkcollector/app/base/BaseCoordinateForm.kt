...
data class BaseCoordinateForm(
    ...
    val mslAltitudeM: String = "",
    val geoidSeparationM: String = "",
    val frame: String = "",
    val epoch: String = "",
    val method: String = "",
    ...
    fun toAcceptedBaseCoordinate(): Result<AcceptedBaseCoordinate> =
        runCatching {
            AcceptedBaseCoordinate(
                ...
                ellipsoidalHeightM = optionalDouble("ellipsoidal height", ellipsoidalHeightM),
                mslAltitudeM = optionalDouble("MSL altitude", mslAltitudeM),
                geoidSeparationM = optionalDouble("geoid separation", geoidSeparationM),
                frame = frame.trim(),
